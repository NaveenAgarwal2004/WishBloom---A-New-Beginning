...
May this collection remind you of how cherished you are, today and always.`,
  ...
  memories: [
    ...
    },
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1428908728789-d2de25dbd4e2?w=1200&q=80',
      type: 'standard' as const,
      tags: ['love', 'nostalgic'],
      rotation: 5.1,
    ...
    },
    {
      ...
      date: '2022-05-03',
      contributor: { id: 'user-003', name: 'Lisa Thompson', contributionCount: 2 },
      imageUrl: 'https://images.unsplash.com/photo-1499781350541-7783f6c6a0c8?w=1200&q=80',
      type: 'standard' as const,
      tags: ['nostalgic'],
      rotation: 4.4,
